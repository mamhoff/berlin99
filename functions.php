...
function underscores_scripts() {
    ...
    wp_enqueue_script( 'skiplink', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20140302', true);


    wp_enqueue_script( 'navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20140302', true);


    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/jquery-1.10.2.min.js', array(), '20140302', true);

       wp_enqueue_script( 'responsive-nav', get_template_directory_uri() . '/js/responsive-nav.min.js', array(), '20140302', true);

    wp_enqueue_script( 'royalslider', get_template_directory_uri() . '/js/jquery.royalslider.min.js', array(), '20140302', true);

    wp_enqueue_script( 'singlePageNav', get_template_directory_uri() . '/js/jquery.singlePageNav.min.js', array(), '20140302', true);

 

    wp_enqueue_script( 'touchy', get_template_directory_uri() . '/js/toucheffects.js', array(), '20140302', true);
